                    ...
                    <form action="#" method="POST" id="formContact" class="">
                        <fieldset class="border border-dark p-2">
                            ...
                            <div class="form-group justify-content-center row">
                                ...
                                <div class="input-group col-md-8">
                                    ...
                                    <input type="text" id="lastName" name="lastName" value="<?= $lastName ?>"
                                        class="form-control <?= ($isSubmit && isset($errors['lastName'])) ? 'is-invalid' : '' ?>  <?= ($isSubmit && !isset($errors['lastName'])) ? 'is-valid' : '' ?>">
                                    <div class="<?= (isset($errors['lastName'])) ? 'invalid-feedback' : ''?>">
                                        <?= $errors['lastName'] ?? '' ?></div>
                                </div>
                            </div>
                            <div class="form-group justify-content-center row">
                                ...
                                <div class="input-group col-md-8">
                                    ...
                                    <input type="text" id="firstName" name="firstName" value="<?= $firstName ?>"
                                        class="form-control <?= ($isSubmit && isset($errors['firstName'])) ? 'is-invalid' : '' ?>  <?= ($isSubmit && !isset($errors['firstName'])) ? 'is-valid' : '' ?>">
                                    <div class="<?= (isset($errors['firstName'])) ? 'invalid-feedback' : ''?>">
                            ...
                            <div class="form-group justify-content-center row">
                                ...
                                <div class="form-check form-check-inline col-md-8 justify-content-around">
                                    <input type="radio" name="gender" id="gender" value="female"
                                        class="form-check-input <?= ($isSubmit && isset($errors['gender'])) ? 'is-invalid' : '' ?>  <?= ($isSubmit && !isset($errors['gender'])) ? 'is-valid': '' ?>"
                                ...
                                <div
                                    class=" input-group col-md-5 <?= (isset($errors['gender'])) ? 'invalid-feedback' : ''?>">
                                    <?= ($isSubmit && (isset($errors['gender']))) ? $errors['gender'] : '' ?></div>
                            </div>
                            <div class="form-group justify-content-center row">
                                ...
                                <div class="input-group col-md-8">
                                    ...
                                    <input name="dateOfBirth" type="date" value="<?= $dateOfBirth?>" id="dateOfBirth"
                                        value="<?=$dateOfBirth?>"
                                        class="form-control <?= ($isSubmit && isset($errors['dateOfBirth'])) ? 'is-invalid' : '' ?>  <?= ($isSubmit && !isset($errors['dateOfBirth'])) ? 'is-valid' : '' ?>">
                                    <div class="<?= (isset($errors['dateOfBirth'])) ? 'invalid-feedback' : ''?>">
                            ...
                            <div class="form-group justify-content-center row">
                                ...
                                <div class="input-group col-md-8">
                                    ...
                                    <input type="text" name="zipCode" value="<?= $zipCode?>" id="zipCode"
                                        class="form-control <?= ($isSubmit && isset($errors['zipCode'])) ? 'is-invalid' : '' ?>  <?= ($isSubmit && !isset($errors['zipCode'])) ? 'is-valid' : '' ?>">
                                    <div class="<?= (isset($errors['zipCode'])) ? 'invalid-feedback' : ''?>">
                                        <?= $errors['zipCode'] ?? '' ?></div>
                                </div>
                            </div>
                            <div class="form-group justify-content-center row">
                                ...
                                <div class="input-group col-md-8">
                                    ...
                                    <input type="text" name="adress" value="<?= $adress?>" id="adress"
                                        class="form-control <?= ($isSubmit && isset($errors['adress'])) ? 'is-invalid' : '' ?>  <?= ($isSubmit && !isset($errors['adress'])) ? 'is-valid' : '' ?>">
                                    <div class="<?= (isset($errors['adress'])) ? 'invalid-feedback' : ''?>">
                                        <?= $errors['adress'] ?? '' ?></div>
                                </div>
                            </div>
                            <div class="form-group justify-content-center row">
                                ...
                                <div class="input-group col-md-8">
                                    ...
                                    <input type="text" name="city" id="city" value="<?= $city?>"
                                        class="form-control <?= ($isSubmit && isset($errors['city'])) ? 'is-invalid' : '' ?>  <?= ($isSubmit && !isset($errors['city'])) ? 'is-valid' : '' ?>">
                                    <div class="<?= (isset($errors['city'])) ? 'invalid-feedback' : ''?>">
                                        <?= $errors['city'] ?? '' ?></div>
                                </div>
                            </div>
                            <div class="form-group justify-content-center row">
                                ...
                                <div class="input-group col-md-8">
                                    ...
                                    <input type="text" name="email" id="email" value="<?= $email?>"
                                        ...
                                        class="form-control <?= ($isSubmit && isset($errors['email'])) ? 'is-invalid' : '' ?>  <?= ($isSubmit && !isset($errors['email'])) ? 'is-valid' : '' ?>">
                                    <div class="<?= (isset($errors['email'])) ? 'invalid-feedback' : ''?>">
                                        <?= $errors['email'] ?? '' ?></div>
                                </div>
                            </div>
                        </fieldset>
                        <fieldset class="border border-dark p-2">
                            ...
                            <div class="form-group justify-content-center row">
                                ...
                                <div class="input-group col-md-8">
                                    ...
                                    <select name="subject" class="custom-select btn btn-outline-success" id="subject">
                            ...
                            <div class="form-group justify-content-center row">
                                ...
                                <div class="input-group col-md-8">
                                    ...
                                    <textarea name="question" id="question"
                                        class="form-control <?= ($isSubmit && isset($errors['question'])) ? 'is-invalid' : '' ?>  <?= ($isSubmit && !isset($errors['question'])) ? 'is-valid' : '' ?>"><?= $question?></textarea>
                                    <div class="<?= (isset($errors['question'])) ? 'invalid-feedback' : ''?>">
                                        <?= $errors['question'] ?? '' ?></div>
                                </div>
                            </div>
                        </fieldset>
                        <div class="form-check d-flex justify-content-around pt-3 pb-3">
                            ...
                            <input type="checkbox" name="agrement" class="custom-control-input" id="agrement"
                                value="agree" checked data-toggle="toggle" data-on="Oui" data-off="Non"
                                data-onstyle="secondary" data-offstyle="danger">
